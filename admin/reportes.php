...
$sqlPedidosPorEstado = "
    SELECT
        ...
        COALESCE(SUM(total), 0) AS total_generado
    FROM pedidos
    GROUP BY estado
...
<main class="section">
    <div class="container">
        ...
        <div class="section-header">
            ...
            <p>
                Métricas comerciales con PHP + MySQL:
                JOINs, GROUP BY, SUM, COUNT, subconsultas y relaciones entre tablas.
            </p>
        </div>
        ...
        <div class="info-cards">
            <div class="info-card">
                ...
                <h3>Facturación</h3>
                <p>$<?php echo number_format($kpis['facturacion_total'], 0, ',', '.'); ?></p>
            </div>

            <div class="info-card">
                <span class="admin-badge">Pedidos</span>
                <h3>Total pedidos</h3>
                <p><?php echo (int)$kpis['total_pedidos']; ?></p>
            </div>

            <div class="info-card">
                <span class="admin-badge">Ticket</span>
                <h3>Ticket promedio</h3>
                <p>$<?php echo number_format($kpis['ticket_promedio'], 0, ',', '.'); ?></p>
            </div>
        </div>
        ...
        <div class="info-cards">
            <div class="info-card">
                ...
                <h3>Productos</h3>
                <p><?php echo (int)$kpis['total_productos']; ?> cargados</p>
            </div>

            <div class="info-card">
                <span class="admin-badge">Usuarios</span>
                <h3>Clientes</h3>
                <p><?php echo (int)$kpis['total_usuarios']; ?> registrados</p>
            </div>

            <div class="info-card">
                <span class="admin-badge">Unidades</span>
                <h3>Vendidas</h3>
                <p><?php echo (int)$kpis['unidades_vendidas']; ?> unidades</p>
            </div>
        </div>
                ...
                <?php foreach ($productosMasVendidos as $producto): ?>
                    <div class="cart-item">
                        <div>
                            ...
                            <p>
                                <?php echo e($producto['bodega'] ?? 'Sin bodega'); ?>
                                ·
                                <?php echo e($producto['categoria'] ?? 'Sin categoría'); ?>
                            </p>
                            <p><strong>Stock actual:</strong> <?php echo (int)$producto['stock']; ?></p>
                        </div>

                        <div style="text-align:right;">
                            <span class="admin-badge">
                                <?php echo (int)$producto['unidades_vendidas']; ?> unidades
                            </span>
                            <br><br>
        ...
        <div class="cart-box" style="max-width:100%;">
            ...
            <p>Relación entre categorías, productos y ventas.</p>
            <br>
            ...
            <?php foreach ($ventasPorCategoria as $item): ?>
                <div class="cart-item">
                    <div>
                        ...
                        <p><strong>Productos distintos:</strong> <?php echo (int)$item['productos_distintos']; ?></p>
                        <p><strong>Unidades vendidas:</strong> <?php echo (int)$item['unidades_vendidas']; ?></p>
                    </div>

                    <strong>
                        $<?php echo number_format($item['total_generado'], 0, ',', '.'); ?>
                    </strong>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="cart-box" style="max-width:100%;">
            ...
            <p>Análisis comercial por bodega y región.</p>
            <br>
        ...
        <div class="cart-box" style="max-width:100%;">
            ...
            <p>Seguimiento operativo del flujo de ventas.</p>
            <br>
                ...
                <?php foreach ($pedidosPorEstado as $item): ?>
                    <div class="cart-item">
                        <div>
                            ...
                            <p><strong>Pedidos:</strong> <?php echo (int)$item['total_pedidos']; ?></p>
                        </div>
